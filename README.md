...
When receiving a subscription intent a `Logicalcrow\Whatsapp\Events\SubscriptionIntentReceived` event will be fired, if the request is successful the `Logicalcrow\Whatsapp\Events\SuccessfullySubscribed` event will fire too.
