...
use Logicalcrow\Whatsapp\Events\SendingMessage;
use Logicalcrow\Whatsapp\Exceptions\MessageRequestException;
use Logicalcrow\Whatsapp\Exceptions\MediaNotFoundException;
use Logicalcrow\Whatsapp\Exceptions\PhoneNumberNameNotFound;
...
class Whatsapp
{
    ...
    public const WHATSAPP_API_VERSION = '20.0';
